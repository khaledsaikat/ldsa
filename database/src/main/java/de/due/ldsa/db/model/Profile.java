...
public abstract class Profile implements SocialNetworkContent, LinkedWithOtherObjects, Serializable
{
     ...
     * @throws DbException Thrown if there are invalid values in the ArrayList containing the IDs.
     */
    public ArrayList<SocialNetworkInterest> getInterests()
            throws DbException {
     ...
     * @throws DbException Thrown, if the ID is not set, or it does not exist.
     */
     ...
     * @throws DbException Thrown if the ID is not set correctly.
     */
     ...
     * @throws DbException Thrown if the Hometown Location ID is not correctly set.
     */
