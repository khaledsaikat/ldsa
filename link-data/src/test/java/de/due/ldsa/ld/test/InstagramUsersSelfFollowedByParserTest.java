...
/**A Test case for {@link InstagramUsersSelfFollowedByParser}.
 * 
 * @author Maik Wosnitzka
 *
 */
public class InstagramUsersSelfFollowedByParserTest {
	
	@Test
	public void testParse() throws JSONException {
		List<Profile> usersRequested = InstagramUsersSelfFollowedByParser.INSTANCE.
