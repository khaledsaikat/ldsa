...
import de.due.ldsa.ld.parsers.InstagramUsersSelfParser;
import de.due.ldsa.model.Profile;

/**A test case for {@link InstagramUsersSelfParser}.
 * 
 * @author Jan Kowollik
 *
 */
public class InstagramUsersSelfParserTest {

	@Test
	public void testParse() throws JSONException {
		Profile profile = InstagramUsersSelfParser.INSTANCE.parse(new
				JSONObject("{\"data\":{"
						+ "\"id\": \"1574083\","
						+ "\"username\": \"snoopdogg\","
