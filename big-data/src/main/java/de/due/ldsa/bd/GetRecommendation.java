...
public class GetRecommendation extends RecommendationModel{
	...
	public final static List<Rating> getRecommendations(int userId, MatrixFactorizationModel model, JavaRDD<Tuple2<Integer, Rating>> ratings, Map<Integer, String> products) {
	        ...
	        //Get top recommended products/movies.
